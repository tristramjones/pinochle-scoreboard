...
export function ThemedButton({
  ...
  const buttonStyles = [
    styles.base,
    {
      ...
      paddingVertical: theme.spacing[size === 'sm' ? 'xs' : size === 'lg' ? 'lg' : 'md'],
      paddingHorizontal: theme.spacing[size === 'sm' ? 'sm' : size === 'lg' ? 'xl' : 'lg'],
  ...
  const textStyles = [
    styles.text,
    {
      ...
      fontSize: theme.typography.fontSizes[size === 'sm' ? 'sm' : size === 'lg' ? 'lg' : 'md'],
